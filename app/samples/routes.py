...
samples = [
    ...
    {
        "id": 4,
        "sample_code": "JL20-01A-4",
        "nickname": "Core Sample - Depth 2.4m",
        "collected_on": date(2025, 9, 20),
        "collected_by": ["Matthew Kenner"],
        "status": "active",
        "storage_location": "Cold Storage · Rack C1",
        "igsn": "IGSN:JL20-01A-4",
        "description": "Core section sample for core correlation work.",
        "is_flagged_for_review": False,
        "site": {"project": 1, "site_name": "Deep Core Site", "station": "DC-02", "stratum": "2.4m", "depth_cm": 240},
        "metadata_flags": ["complete"],
        "associated_projects": [{"project_id": 1, "role": "Primary"}],
        "attachments": {"images": [], "notes": [], "instrument_logs": []},
        "processing": None,
        "physical_analysis": None,
        "imaging": {"sessions": [], "next_steps": None},
        "geochemistry": None,
        "correlation": {"targets": [], "checklist": [], "summary": ""},
        "workflow_status": [{"name": "Collection", "state": "Complete", "updated": "2025-09-20"}]
    },
    {
        "id": 5,
        "sample_code": "JL20-01A-5",
        "nickname": "Cryptotephra Sample - Lake Sediment",
        "collected_on": date(2025, 9, 23),
        "collected_by": ["Ian Keitlan"],
        "status": "active",
        "storage_location": "Cold Storage · Rack D2",
        "igsn": "IGSN:JL20-01A-5",
        "description": "Fine cryptotephra picked from lake core sample.",
        "is_flagged_for_review": False,
        "site": {"project": 4, "site_name": "Summit Lake Core", "station": "SL-03"},
        "metadata_flags": ["partial"],
        "associated_projects": [{"project_id": 4, "role": "Primary"}],
        "attachments": {"images": [], "notes": [], "instrument_logs": []},
        "processing": None,
        "physical_analysis": None,
        "imaging": {"sessions": [], "next_steps": None},
        "geochemistry": None,
        "correlation": {"targets": [], "checklist": [], "summary": ""},
        "workflow_status": [{"name": "Collection", "state": "Complete", "updated": "2025-09-23"}]
    },
    {
        "id": 6,
        "sample_code": "JL20-01A-6",
        "nickname": "Scoria Fragments - Cinder Cone",
        "collected_on": date(2025, 9, 25),
        "collected_by": ["Carlos Cortes Garcia"],
        "status": "active",
        "storage_location": "Cold Storage · Rack E1",
        "igsn": "IGSN:JL20-01A-6",
        "description": "Scoria fragments collected near cinder cone.",
        "is_flagged_for_review": False,
        "site": {"project": 3, "site_name": "Cinder Cone Outcrop", "station": "CC-01"},
        "metadata_flags": ["complete"],
        "associated_projects": [{"project_id": 3, "role": "Primary"}],
        "attachments": {"images": [], "notes": [], "instrument_logs": []},
        "processing": None,
        "physical_analysis": None,
        "imaging": {"sessions": [], "next_steps": None},
        "geochemistry": None,
        "correlation": {"targets": [], "checklist": [], "summary": ""},
        "workflow_status": [{"name": "Collection", "state": "Complete", "updated": "2025-09-25"}]
    },
    {
        "id": 7,
        "sample_code": "JL20-01A-7",
        "nickname": "Fine Ash Layer - Proximal Site",
        "collected_on": date(2025, 9, 24),
        "collected_by": ["Samantha Diaz"],
        "status": "active",
        "storage_location": "Cold Storage · Rack F3",
        "igsn": "IGSN:JL20-01A-7",
        "description": "Fine ash layer sample from proximal site.",
        "is_flagged_for_review": False,
        "site": {"project": 1, "site_name": "Proximal Transect", "station": "PT-01"},
        "metadata_flags": ["complete"],
        "associated_projects": [{"project_id": 1, "role": "Primary"}],
        "attachments": {"images": [], "notes": [], "instrument_logs": []},
        "processing": None,
        ...
        "geochemistry": None,
        "correlation": {"targets": [], "checklist": [], "summary": ""},
        "workflow_status": [{"name": "Collection", "state": "Complete", "updated": "2025-09-24"}]
    },
    {
        "id": 8,
        "sample_code": "JL20-01A-8",
        "nickname": "Scoria Fragments - Supplemental",
        "collected_on": date(2025, 9, 22),
        "collected_by": ["John Wright"],
        "status": "active",
        "storage_location": "Cold Storage · Rack G1",
        "igsn": "IGSN:JL20-01A-8",
        "description": "Supplemental scoria fragments collected for density work.",
        "is_flagged_for_review": False,
        "site": {"project": 2, "site_name": "Supplemental Site", "station": "SU-01"},
        "metadata_flags": ["complete"],
        "associated_projects": [{"project_id": 2, "role": "Primary"}],
        "attachments": {"images": [], "notes": [], "instrument_logs": []},
        "processing": None,
        "physical_analysis": None,
        "imaging": {"sessions": [], "next_steps": None},
        "geochemistry": None,
        "correlation": {"targets": [], "checklist": [], "summary": ""},
        "workflow_status": [{"name": "Collection", "state": "Complete", "updated": "2025-09-22"}]
    }
]
